...
window.addEventListener("load", function () {
  // Retrieve the field values from the query string of the URL
  var orderData = decodeURIComponent(
    location.search.slice(1).replace(/\+/g, " ")
  );

  // Split the orderData into substrings at every occurrence of '&' or '='
  var orderFields = orderData.split(/[&=]/);

  // Write the values from orderFields into the indicated fields of the order form
  ...
  // Event listener for expDate input
