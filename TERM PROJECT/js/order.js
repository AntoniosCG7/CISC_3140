...
// Event listeners
document
  .querySelector("#product1 .item-type")
  .addEventListener("change", calculateProduct1Order);
document
  .querySelector("#product1 .dimensions")
  .addEventListener("change", calculateProduct1Order);
document
  .querySelector("#product1 .qty")
  .addEventListener("change", calculateProduct1Order);

document
  .querySelector("#product2 .item-type")
  .addEventListener("change", calculateProduct2Order);
document
  .querySelector("#product2 .size")
  .addEventListener("change", calculateProduct2Order);
document
  .querySelector("#product2 .qty")
  .addEventListener("change", calculateProduct2Order);

document
  .querySelector("#product3 .item-type")
  .addEventListener("change", calculateProduct3Order);
document
  .querySelector("#product3 .qty")
  .addEventListener("change", calculateProduct3Order);
